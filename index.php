<?php
    ...
    if(isset($_POST['Signup']))
    {
        ...
        elseif ($_REQUEST['account_Type']=='student')
        {
			...
			echo $full_Name;
             $query="INSERT INTO studentaccount(full_Name,email,password) VALUES('".$_POST['full_Name']."','".$_POST['email']."','".$_POST['password']."')";
            $result=$connect->query($query);
			echo "Done Karo";
    ...
    elseif (isset($_POST['login']))
    {
        ...
        else
        {
            ...
            {
                $_SESSION['login_user_Mail']=$email;
				$_SESSION['login_user_Name']=$rows[1];
